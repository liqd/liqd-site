    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro_en', wagtail.wagtailcore.fields.RichTextField(verbose_name=b'Teasertext', blank=True)),
                ('intro_de', wagtail.wagtailcore.fields.RichTextField(verbose_name=b'Teasertext', blank=True)),
